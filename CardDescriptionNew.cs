...
namespace Obeliskial_Essentials
{
    ...
    public class CardDescriptionNew
    {
        ...
        /*  this is a copy of CardDataNew.Instance.SetDescriptionNew() with some minor modifications:
                gold/shards gain for enchantments
            
            below is a copy of CardDataNew.Instance.SetTarget() that has been rearranged for readability and has the following additions:
        ...
        */
        ...
        // [HarmonyPrefix]
        // [HarmonyPatch(typeof(CardDataNew), "SetDescriptionNew")]
        // public static bool SetDescriptionNewPrefix(ref CardRealtimeData __instance,
        ...
        //                     CardDataNew cardData = Globals.Instance.GetCardData(__instance.AddCardId, false);
        //                     if ((UnityEngine.Object)cardData != (UnityEngine.Object)null)
        //                     {
        //                         stringBuilder2.Append(__instance.ColorFromCardDataNewRarity(cardData));
        ...
        //                         CardDataNew cardData = Globals.Instance.GetCardData(itemData.CardToGain.Id, false);
        //                         if ((UnityEngine.Object)cardData != (UnityEngine.Object)null)
        //                         {
        //                             stringBuilder2.Append(__instance.ColorFromCardDataNewRarity(cardData));
        //                             stringBuilder2.Append(cardData.CardName);
        ...
        // public static string medsColorFromCardDataNewRarity(CardDataNew _cData)
        // {
        ...
        public static bool SetTargetPrefix(ref CardRealtimeData __instance, ref string ___target)
        {
            if (__instance.AutoplayDraw)
                ...
                ___target = Texts.Instance.GetText("anyone");
            else if (__instance.CardClass != Enums.CardClass.Monster)
            {
                if (__instance.TargetSide == Enums.CardTargetSide.Friend)
                {
                    ...
                    {
                        ___target = Texts.Instance.GetText("allHeroes");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.Random)
                    {
                        ___target = Texts.Instance.GetText("randomHero");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.Front)
                    {
                        ___target = Texts.Instance.GetText("frontHero");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.Back)
                    {
                        ___target = Texts.Instance.GetText("backHero");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.Middle)
                    {
                        ___target = Texts.Instance.GetText("middleHero");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.Slowest)
                    {
                        ___target = Texts.Instance.GetText("slowestHero");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.Fastest)
                    {
                        ___target = Texts.Instance.GetText("fastestHero");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.MostHP)
                    {
                        ___target = Texts.Instance.GetText("mostHPHero");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.LeastHP)
                    {
                        ___target = Texts.Instance.GetText("leastHPHero");
                    }
                    else
                    {
                        ___target = Texts.Instance.GetText("hero");
                    }
                }
                else if (__instance.TargetSide == Enums.CardTargetSide.FriendNotSelf)
                {
                    ___target = __instance.TargetType == Enums.CardTargetType.Global ? "All Other Heroes" : Texts.Instance.GetText("otherHero");
                }
                else if (__instance.TargetSide == Enums.CardTargetSide.Enemy)
                {
                    if (__instance.TargetType == Enums.CardTargetType.Global)
                    {
                        ___target = Texts.Instance.GetText("allMonsters");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.Random)
                    {
                        ___target = Texts.Instance.GetText("randomMonster");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.Front)
                    {
                        ___target = Texts.Instance.GetText("frontMonster");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.Back)
                    {
                        ___target = Texts.Instance.GetText("backMonster");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.MostHP)
                    {
                        ___target = Texts.Instance.GetText("mostHPMonster");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.LeastHP)
                    {
                        ___target = Texts.Instance.GetText("leastHPMonster");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.Middle)
                    {
                        ___target = Texts.Instance.GetText("middleMonster");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.Slowest)
                    {
                        ___target = Texts.Instance.GetText("slowestMonster");
                    }
                    else if (__instance.TargetPosition == Enums.CardTargetPosition.Fastest)
                    {
                        ___target = Texts.Instance.GetText("fastestMonster");
                    }
                    else
                    {
                        ___target = Texts.Instance.GetText("monster");
                    }
                }
            }
            else if (__instance.CardClass == Enums.CardClass.Monster)
            {
                if (__instance.TargetSide == Enums.CardTargetSide.Friend)
                    ___target = __instance.TargetType != Enums.CardTargetType.Global ? (__instance.TargetPosition != Enums.CardTargetPosition.Random ? (__instance.TargetPosition != Enums.CardTargetPosition.Front ? (__instance.TargetPosition != Enums.CardTargetPosition.Back ? (__instance.TargetPosition != Enums.CardTargetPosition.Middle ? (__instance.TargetPosition != Enums.CardTargetPosition.Slowest ? (__instance.TargetPosition != Enums.CardTargetPosition.Fastest ? (__instance.TargetPosition != Enums.CardTargetPosition.LeastHP ? (__instance.TargetPosition != Enums.CardTargetPosition.MostHP ? Texts.Instance.GetText("monster") : Texts.Instance.GetText("mostHPMonster")) : Texts.Instance.GetText("leastHPMonster")) : Texts.Instance.GetText("fastestMonster")) : Texts.Instance.GetText("slowestMonster")) : Texts.Instance.GetText("middleMonster")) : Texts.Instance.GetText("backMonster")) : Texts.Instance.GetText("frontMonster")) : Texts.Instance.GetText("randomMonster")) : Texts.Instance.GetText("allMonsters");
                else if (__instance.TargetSide == Enums.CardTargetSide.FriendNotSelf)
                    ___target = Texts.Instance.GetText("otherMonster");
                else if (__instance.TargetSide == Enums.CardTargetSide.Enemy)
        ...
        public static void BinbinNormalizeDescription(ref CardRealtimeData __instance, StringBuilder stringBuilder1, bool includeInSearch)
        {
        ...
        public static void BinbinCustomText(TextLocation location, ref StringBuilder stringBuilder, string card)
        {
            ...
            //     return;
            // }
            // Dictionary<CardDataNew, List<string>> cardsToAddTextTo = TextToAddAtLocations[location];
                ...
                bool _generated = false)
        {
            ...
            if (needsUpdating)
            {
                ...
                if (Globals.Instance.CardsDescriptionNormalized.TryGetValue(cardId, out string newDescription))
                {
                    ...
                    // LogDebug($"SetCardPostfix - Setting Combat Description for {__instance.CardDataNew.Id} - {newDescription}");
                }
                else
                {
